    ...
    public partial class SysW
    {
        ...
        */
        ...
        public static void AddMouseMoveEvent(int dx, int dy)
        {
            ...
            event_list.Add(Lib.sys.GenerateMouseMoveEvent(dx, dy));
        }
        ...
        public static void AddMouseButtonEvent(int button, bool pressed)
        {
            switch (button)
            {
                case 1:
                    ...
                    event_list.Add(Lib.sys.GenerateMouseButtonEvent(1, pressed));
                    break;
                case 2:
                    mouse_polls.Add(new MousePoll(M.M_ACTION3, pressed ? 1 : 0));
                    event_list.Add(Lib.sys.GenerateMouseButtonEvent(3, pressed));
                    break;
                case 3:
                    mouse_polls.Add(new MousePoll(M.M_ACTION2, pressed ? 1 : 0));
                    event_list.Add(Lib.sys.GenerateMouseButtonEvent(2, pressed));
                    break;
            }
        }
