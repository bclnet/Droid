...
namespace Droid.Core
{
    public class Curve_float
    {
        ...
        /// <returns></returns>
        public virtual int AddValue(float time, float value)
        {
        ...
        /// <param name="time">The time.</param>
        /// <returns></returns>
        public virtual float GetCurrentValue(float time)
        {
            var i = IndexForTime(time);
        ...
        /// <param name="time">The time.</param>
        /// <returns></returns>
        public virtual float GetCurrentSecondDerivative(float time)
            => values[0] - values[0];
        ...
        public void SetValue(int index, float value) { values[index] = value; changed = true; }
        public float GetValue(int index) => values[index];
        public float GetValueAddress(int index) => values[index];
        ...
        protected List<float> values;         // knot values
        ...
        /// <returns></returns>
        protected float ValueForIndex(int index)
        {
    ...
    public class Curve_Bezier_float : Curve_float
    {
        /// <summary>
        /// get the value for the given time
        /// </summary>
        ...
        /// <returns></returns>
        public unsafe override float GetCurrentValue(float time)
        {
        ...
        /// <param name="time"></param>
        /// <returns></returns>
        public unsafe override float GetCurrentFirstDerivative(float time)
        {
            var bvals = stackalloc float[values.Count];
        ...
        /// <param name="time"></param>
        /// <returns></returns>
        public unsafe override float GetCurrentSecondDerivative(float time)
        {
            var bvals = stackalloc float[values.Count];
    ...
    public class Curve_QuadraticBezier_float : Curve_float
    {
        /// <summary>
        /// get the value for the given time
        /// </summary>
    ...
    public class Curve_CubicBezier_float : Curve_float
    {
        /// <summary>
        /// get the value for the given time
        /// </summary>
    ...
    public class Curve_Spline_float : Curve_float
    {
        ...
        /// <summary>
        /// return the clamped time based on the boundary float
        /// </summary>
        /// <param name="t">The t.</param>
        /// <returns></returns>
    ...
    public class Curve_NaturalCubicSpline_float : Curve_Spline_float
    {
        ...
        /// <param name="time">The time.</param>
        /// <returns></returns>
        public override float GetCurrentValue(float time)
        {
        ...
        /// <param name="time">The time.</param>
        /// <returns></returns>
        public override float GetCurrentFirstDerivative(float time)
        {
            var clampedTime = ClampedTime(time);
            var i = IndexForTime(clampedTime);
            var s = time - TimeForIndex(i);
        ...
        /// <param name="time">The time.</param>
        /// <returns></returns>
        public override float GetCurrentSecondDerivative(float time)
        {
            var clampedTime = ClampedTime(time);
            var i = IndexForTime(clampedTime);
            var s = time - TimeForIndex(i);
        ...
        protected List<float> b = new();
        protected List<float> c = new();
        protected List<float> d = new();
        ...
        protected unsafe void SetupFree()
        {
            ...
            alpha = (float*)_alloca16((values.Count - 1) * sizeof(float));
            beta = (float*)_alloca16(values.Count * sizeof(float));
            gamma = (float*)_alloca16((values.Count - 1) * sizeof(float));
            delta = (float*)_alloca16(values.Count * sizeof(float));
            ...
            for (i = 1; i < values.Count - 1; i++)
            {
                float sum = 3.0f * (d0[i - 1] * values[i + 1] - d1[i] * values[i] + d0[i] * values[i - 1]);
    ...
    public class Curve_CatmullRomSpline_float : Curve_Spline_float
    {
        /// <summary>
        /// get the value for the given time
        /// </summary>
        ...
        /// <param name="time">The time.</param>
        /// <returns></returns>
        public unsafe float GetCurrentSecondDerivative(float time)
        {
            if (times.Count == 1)
                return values[0] - values[0];
    ...
    public class Curve_KochanekBartelsSpline_float : Curve_Spline_float
    {
        /// <summary>
        /// add a timed/value pair to the spline
        /// returns the index to the inserted pair
        ...
        /// <param name="value">The value.</param>
        /// <returns></returns>
        public override int AddValue(float time, float value)
        {
            var i = IndexForTime(time);
            times.Insert(i, time);
            values.Insert(i, value);
        ...
        /// <returns></returns>
        public virtual int AddValue(float time, float value, float[] tension, float[] continuity, float[] bias)
        {
            var i = IndexForTime(time);
            times.Insert(i, time);
            values.Insert(i, value);
        ...
        protected void TangentsForIndex(int index, out float t0, out float t1)
        {
    ...
    public class Curve_BSpline_float : Curve_Spline_float
    {
        public Curve_BSpline_float()
    ...
    public class Curve_UniformCubicBSpline_float : Curve_BSpline_float
    {
        public Curve_UniformCubicBSpline_float()
    ...
    public class Curve_NonUniformBSpline_float : Curve_BSpline_float
    {
        /// <summary>
        /// get the value for the given time
        /// </summary>
    ...
    public class Curve_NURBS_float : Curve_NonUniformBSpline_float
    {
        /// <summary>
        /// add a timed/value pair to the spline
        /// returns the index to the inserted pair
        ...
        /// <returns></returns>
        public virtual int AddValue(float time, float value, float weight)
        {
            var i = IndexForTime(time);
            times.Insert(i, time);
            values.Insert(i, value);
        ...
        public unsafe override float GetCurrentFirstDerivative(float time)
        {
            ...
            float vb, vd1; vb = vd1 = values[0] - values[0];
        ...
        public unsafe override float GetCurrentSecondDerivative(float time)
        {
            ...
            float vb, vd1, vd2; vb = vd1 = vd2 = values[0] - values[0];
