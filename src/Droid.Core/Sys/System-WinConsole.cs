...
namespace Droid.Sys
{
    public class ConX
    {
        ...
        {
            var DEDCLASS = Config.WIN32_CONSOLE_CLASS;
            ...
            var nHeight = -Extensions.MulDiv(8, GetDeviceCaps(hDC, LOGPIXELSY), 72);
        ...
        public static void ShowConsole(int visLevel, bool quitOnClose)
        {
            ...
            switch (visLevel)
            {
                case 0:
                    ...
                    break;
                case 1:
                    ShowWindow(s_wcd.hWnd, ShowWindowCmdShow.SW_SHOWNORMAL);
