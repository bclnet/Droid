...
namespace Gengine.Render
{
    class DroidEtc1
    {
        ...
        void etc1_encode_block(byte[] pIn, uint validPixelMask, byte[] pOut) => throw new NotImplementedException();
        ...
        // value of pixel (x, y).
        void etc1_decode_block(byte[] pIn, byte[] pOut) => throw new NotImplementedException();

        // Return the size of the encoded image data (does not include size of PKM header).
        uint etc1_get_encoded_data_size(uint width, uint height) => throw new NotImplementedException();
        ...
        int etc1_encode_image(byte[] pIn, uint width, uint height, uint pixelSize, uint stride, byte[] pOut) => throw new NotImplementedException();
        ...
        // pixelSize can be 2 or 3. 2 is an GL_UNSIGNED_SHORT_5_6_5 image, 3 is a GL_BYTE RGB image.
        // returns non-zero if there is an error.
        int etc1_decode_image(byte[] pIn, byte[] pOut, uint width, uint height, uint pixelSize, uint stride) => throw new NotImplementedException();
