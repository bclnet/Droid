namespace Gengine.Render
{
    static partial class R
    {
        ...
        public enum IMAGE_CLASSIFICATION
        {
            IC_NPC,
            IC_WEAPON,
            IC_MONSTER,
        ...
        const ImageClassificate IC_Info[] = {
        new ImageClassificate{ "models/characters", "Characters", IC_NPC, 512, 512 },
        new ImageClassificate{ "models/weapons", "Weapons", IC_WEAPON, 512, 512 },
        new ImageClassificate{ "models/monsters", "Monsters", IC_MONSTER, 512, 512 },
        new ImageClassificate{ "models/mapobjects", "Model Geometry", IC_MODELGEOMETRY, 512, 512 },
        new ImageClassificate{ "models/items", "Items", IC_ITEMS, 512, 512 },
        new ImageClassificate{ "models", "Other model textures", IC_MODELSOTHER, 512, 512 },
        new ImageClassificate{ "guis/assets", "Guis", IC_GUIS, 256, 256 },
        new ImageClassificate{ "textures", "World Geometry", IC_WORLDGEOMETRY, 256, 256 },
        new ImageClassificate{ "", "Other", IC_OTHER, 256, 256 }
    };


        static int ClassifyImage(string name)
        {
            string str;
            str = name;
        ...
        // the default image will be grey with a white box outline to allow you to see the mapping coordinates on a surface
