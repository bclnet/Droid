...
namespace Gengine.Library
{
    ...
    public static class StringX
    {
        ...
        {
            if (src != null) { common.Warning("Str::Copynz: NULL src"); return; }
            if (destsize < 1) { common.Warning("Str::Copynz: destsize < 1"); return; }
