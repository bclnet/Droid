...
namespace System.NumericsX
{
    ...
    public unsafe static class Simd
    {
        ...
        public static DotcdDelegate Dotcd = SimdGeneric.Dotcd;[UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void DotcdDelegate(float* dst, Vector3 constant, Span<DrawVert> src, int count);
        ...
        public static DotpdDelegate Dotpd = SimdGeneric.Dotpd;[UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void DotpdDelegate(float* dst, Plane constant, Span<DrawVert> src, int count);
        ...
        public static MinMaxdDelegate MinMaxd = SimdGeneric.MinMaxd;[UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void MinMaxdDelegate(out Vector3 min, out Vector3 max, Span<DrawVert> src, int count);
        public static MinMaxdiDelegate MinMaxdi = SimdGeneric.MinMaxdi;[UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void MinMaxdiDelegate(out Vector3 min, out Vector3 max, Span<DrawVert> src, int* indexes, int count);
        public static MinMaxdsDelegate MinMaxds = SimdGeneric.MinMaxds;[UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void MinMaxdsDelegate(out Vector3 min, out Vector3 max, Span<DrawVert> src, short* indexes, int count);
        ...
        public static TransformVertsDelegate TransformVerts = SimdGeneric.TransformVerts;[UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void TransformVertsDelegate(Span<DrawVert> verts, int numVerts, JointMat* joints, Vector4* weights, int* index, int numWeights);
        public static TracePointCullDelegate TracePointCull = SimdGeneric.TracePointCull;[UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void TracePointCullDelegate(byte* cullBits, out byte totalOr, float radius, Plane* planes, Span<DrawVert> verts, int numVerts);
        public static DecalPointCullDelegate DecalPointCull = SimdGeneric.DecalPointCull;[UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void DecalPointCullDelegate(byte* cullBits, Plane* planes, Span<DrawVert> verts, int numVerts);
        public static OverlayPointCullDelegate OverlayPointCull = SimdGeneric.OverlayPointCull;[UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void OverlayPointCullDelegate(byte* cullBits, Vector2* texCoords, Plane* planes, Span<DrawVert> verts, int numVerts);
        public static DeriveTriPlanesDelegate DeriveTriPlanesi = SimdGeneric.DeriveTriPlanesi;[UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void DeriveTriPlanesDelegate(Plane* planes, Span<DrawVert> verts, int numVerts, int* indexes, int numIndexes);
        public static DeriveTriPlanessDelegate DeriveTriPlaness = SimdGeneric.DeriveTriPlaness;[UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void DeriveTriPlanessDelegate(Plane* planes, Span<DrawVert> verts, int numVerts, short* indexes, int numIndexes);
        public static DeriveTangentsiDelegate DeriveTangentsi = SimdGeneric.DeriveTangentsi;[UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void DeriveTangentsiDelegate(Plane* planes, Span<DrawVert> verts, int numVerts, int* indexes, int numIndexes);
        public static DeriveTangentssDelegate DeriveTangentss = SimdGeneric.DeriveTangentss;[UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void DeriveTangentssDelegate(Plane* planes, Span<DrawVert> verts, int numVerts, short* indexes, int numIndexes);
        public static DeriveUnsmoothedTangentsDelegate DeriveUnsmoothedTangents = SimdGeneric.DeriveUnsmoothedTangents;[UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void DeriveUnsmoothedTangentsDelegate(Span<DrawVert> verts, DominantTri* dominantTris, int numVerts);
        public static NormalizeTangentsDelegate NormalizeTangents = SimdGeneric.NormalizeTangents;[UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void NormalizeTangentsDelegate(Span<DrawVert> verts, int numVerts);
        public static CreateTextureSpaceLightVectorsDelegate CreateTextureSpaceLightVectors = SimdGeneric.CreateTextureSpaceLightVectors;[UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void CreateTextureSpaceLightVectorsDelegate(Vector3* lightVectors, Vector3 lightOrigin, Span<DrawVert> verts, int numVerts, int* indexes, int numIndexes);
        public static CreateSpecularTextureCoordsDelegate CreateSpecularTextureCoords = SimdGeneric.CreateSpecularTextureCoords;[UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate void CreateSpecularTextureCoordsDelegate(Vector4* texCoords, Vector3 lightOrigin, Vector3 viewOrigin, Span<DrawVert> verts, int numVerts, int* indexes, int numIndexes);
        public static CreateShadowCacheDelegate CreateShadowCache = SimdGeneric.CreateShadowCache;[UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate int CreateShadowCacheDelegate(Vector4* vertexCache, int* vertRemap, Vector3 lightOrigin, Span<DrawVert> verts, int numVerts);
        public static CreateVertexProgramShadowCacheDelegate CreateVertexProgramShadowCache = SimdGeneric.CreateVertexProgramShadowCache;[UnmanagedFunctionPointer(CallingConvention.Cdecl)] public delegate int CreateVertexProgramShadowCacheDelegate(Vector4* vertexCache, Span<DrawVert> verts, int numVerts);
