...
//            if (o_boxIndex != null)
//            {
//                boxIndex = stackalloc int[o_x.Size];
...
//            rowPtrs = stackalloc float*[m.NumRows];
//            for (i = 0; i < m.NumRows; i++)
//                rowPtrs[i] = m[i];

//            // tells if a variable is at the low boundary, high boundary or inbetween
//            side = (int*)_alloca16(m.NumRows * sizeof(int));

//            // index to keep track of the permutation
//            permuted = (int*)_alloca16(m.NumRows * sizeof(int));
//            for (i = 0; i < m.NumRows; i++)
//                permuted[i] = i;
...
//            var y0 = stackalloc float[numClamped];
//            var z0 = stackalloc float[numClamped];
//            var y1 = stackalloc float[numClamped];
//            var z1 = stackalloc float[numClamped];
...
//            var ptr = stackalloc float[numClamped];
//            for (i = 0; i < numClamped; i++)
//                ptr[i] = rowPtrs[i][d];
