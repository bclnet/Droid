...
using System.IO;
using System.Text;
using static Droid.Framework.K;
...
namespace Droid.Framework
{
    ...
    public static class KeyInput
    {
        ...
        static readonly (string n, K k, string si)[] keynames = new (string, K, string)[]{
                ("TAB",             K_TAB,              "#str_07018"),
                ...
                ("SEMICOLON",       (K)';',             "#str_07129"),	// because a raw semicolon separates commands
                ("APOSTROPHE",      (K)'\'',            "#str_07130")	// because a raw apostrophe messes with parsing
        };
