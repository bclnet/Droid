...
// idScreenRect gets carried around with each drawSurf, so it makes sense to keep it compact, instead of just using the idBounds class
class ScreenRect {
...
ScreenRect R_ScreenRectFromViewFrustumBounds( const idBounds &bounds );
